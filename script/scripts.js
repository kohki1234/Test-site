...
window.abctaglet = function(payload){
   window.location.href="https://bcrw.apple.com/business/api/messageprofiles/redirecthelper?service=iMessage&recipient=urn:biz:44542500-8433-4337-b319-6bc47a5ba28c&biz-intent-id=インテントID&biz-group-id=グループID";
   console.log(payload);
   }
